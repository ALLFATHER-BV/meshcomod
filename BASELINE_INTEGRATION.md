...
3. Companion app: merge MyMesh, main.cpp, SerialBLEInterface with upstream 1.14; preserve history/sync, writeFrameToAll, BLE priority queue, WiFi reconnect.
4. Persistence: NodePrefs, DataStore — upstream 1.14 fields (path_hash_mode, autoadd_max_hops) + our format.
