...
**Highlights:**
- **WSS cert acceptance:** Opening https://deviceIP:8765 in a browser now returns a 200 OK HTML page instead of closing the connection, so you can accept the self-signed certificate and then use wss:// from the client.
