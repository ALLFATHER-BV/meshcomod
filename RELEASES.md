...
**Firmware version:** v1.14.0.5 (meshcomod on upstream 1.14+). **Build date:** 24 Feb 2026.
...
- **Version and date:** Boot/device info show v1.14.0.5 and 24 Feb 2026; MyMesh.h fallback kept in sync.
