...
2. **Build** — Build both Heltec V4 and V3 USB+TCP firmware (see build.sh / platformio).
3. **Create versioned folder** — Create `prebuilt/releases/<version>/` and copy the four prebuilt bins into it. Add `notes.md` in that folder.
